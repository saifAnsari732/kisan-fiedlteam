...
export default function App() {
  ...
  return (
    <div className="h-[100dvh] w-full bg-stone-200/80 flex flex-col items-center justify-center selection:bg-rose-600 selection:text-white font-sans overflow-hidden">
      {/* Phone Frame Container */}
      <div className="w-full h-full sm:h-[100dvh] sm:max-w-md bg-[#F1F5F9] sm:border-x sm:border-stone-300 sm:shadow-2xl flex flex-col relative">
        ...
        {toastMessage && (
          <div className="absolute top-16 left-4 right-4 z-50 bg-stone-900 text-white px-3.5 py-2.5 rounded-lg shadow-xl border border-stone-700 flex items-center gap-2 text-xs font-medium animate-in slide-in-from-top-2 duration-200">
          ...
          {!currentUser ? (
            ...
            <div className="py-2 space-y-4">
              <div className="text-center px-2">
                <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-rose-100 text-rose-800 uppercase tracking-wide mb-2">
            ...
            <div className="space-y-3.5">
              ...
              <div className="bg-white rounded-xl border border-stone-200 p-3.5 shadow-xs flex items-center justify-between">
                <div>
                ...
                <div className="flex items-center gap-2">
                  <div className="px-2.5 py-1 bg-stone-50 border border-stone-200 rounded-md text-center">
                    ...
                    <span className="text-xs font-bold text-stone-800">{totalReportsCount}</span>
                  </div>
              ...
              <div className="bg-stone-200/80 p-1 rounded-lg flex items-center border border-stone-300/80">
                <button
        ...
        {currentUser && (
          <nav className="absolute bottom-0 left-0 right-0 h-14 bg-white border-t border-stone-200 px-4 flex items-center justify-around z-20 shadow-lg">
            <button
              onClick={() => setActiveTab('create')}
              className={`flex flex-col items-center justify-center gap-0.5 flex-1 py-1 transition-colors cursor-pointer ${
                activeTab === 'create' ? 'text-rose-600' : 'text-stone-400 hover:text-stone-600'
              }`}
            >
            ...
            <button
              onClick={() => setActiveTab('list')}
              className={`flex flex-col items-center justify-center gap-0.5 flex-1 py-1 transition-colors cursor-pointer ${
                activeTab === 'list' ? 'text-rose-600' : 'text-stone-400 hover:text-stone-600'
              }`}
            >
